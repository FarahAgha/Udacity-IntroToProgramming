...
def testCode():
    ...
    assert daysBetweenDates(2012, 9, 30, 2012, 10, 30)
    assert daysBetweenDates(2012, 1, 1, 2013, 1, 1)
    assert daysBetweenDates(2012, 9, 1, 2012, 9, 4)
    assert daysBetweenDates(2012, 12, 6, 2012, 12, 8)
    assert daysBetweenDates(2012, 6, 29, 2013, 6, 29)
